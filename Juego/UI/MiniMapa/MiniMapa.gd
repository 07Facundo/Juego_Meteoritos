...
func _unhandled_input(event: InputEvent) -> void: 
	if event.is_action_pressed("mini_mapa"): 
...
func conectar_seniales() ->void:
	Eventos.connect("nivel_iniciando", self, "_on_nivel_iniciado") 
...
func obtener_objetos_minimapa() -> void:
	var objetos_en_ventana: Array = get_tree().get_nodes_in_group("mini_mapa") 
